...
router.post("/", async (req, res) => {
  ...
  try {
    await resend.batch.send([
      {
        from: "JD Multiprocess & Services <no-reply@nasirgriffin.com>",
        to: [process.env.CLIENT_EMAIL],
        subject: "New website inquiry (JD Multiprocess & Services)",
        html: `
                  ...
                  <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="width:640px;max-width:94%;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e9ecf2;">
                    ...
                    <tr>
                      <td style="padding:18px 28px;background:#f9fafb;border-top:1px solid #e5e7eb;color:#6b7280;font-size:12px;line-height:18px;">
                        This message was sent automatically from the JD Multiprocess & Services contact form.
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td align="center">
                  <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="width:640px;max-width:94%;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e9ecf2;">
                    ...
                    <tr>
                      <td style="padding:18px 28px;background:#f9fafb;border-top:1px solid #e5e7eb;color:#6b7280;font-size:12px;line-height:18px;">
                        This is an automated confirmation from JD Multiprocess & Services. Please do not share sensitive personal information via email.
                      </td>
                    </tr>
                  </table>
                </td>
