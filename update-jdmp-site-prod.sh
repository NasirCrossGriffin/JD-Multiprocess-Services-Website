#!/bin/bash
cd /client-sites/JD-Multiprocess-Services-Website || {
...
cd /client-sites/JD-Multiprocess-Services-Website/frontend || {
        echo "Unable to change directories."
        exit 1
}
...
rm -rf /client-sites/JD-Multiprocess-Services-Website/backend/build || {
        echo "Unable to delete build folder."
        exit 1
}

mv build /client-sites/JD-Multiprocess-Services-Website/backend || {
